			...
			<div class="row text-center">
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							<td class="text-start">
								<img alt="이미지" src="./upFile/s_${g.gfile }">
							</td>
							<td class="align-middle fs-2">${g.gtitle }</td>
							<td class="align-middle fs-4">${g.gdate }</td>
							<td class="align-middle fs-2">${g.glike }</td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
